...
eight-bit map to four times its size. Loading the file instead lets Blender's own
threaded decoders fill an ImBuf of the right depth -- and because the file lives
in the arena, the pages Blender reads are the pages Painter wrote. That is the
floor this leg can reach, and it is reached here.
